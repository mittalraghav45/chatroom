...
<body>
  ...
  <header class="site-header sticky-top py-1">
    <nav class="container d-flex flex-column flex-md-row justify-content-between">
      ...
      <a class="py-2 d-none d-md-inline-block" href="#">ChatRoom</a>
  ...
  <main>
    <div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
      <div class="col-md-5 p-lg-5 mx-auto my-5">
        <h1 class="display-4 fw-normal">Raghav's Chatroom </h1>
        <p class="lead fw-normal">Welcome to my chatroom. Let's start chatting!!!.....</p>


        <form action="data.php" method="POST">
          Raghav's ChatRoom Name: <input type="text" name="room_name">
           <button class="btn btn-outline-secondary" href="#">Claim Room</a>
        </form>
